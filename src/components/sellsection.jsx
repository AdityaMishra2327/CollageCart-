...
const SellSection = () => {
    return (
        <div id="sell-section" className="py-12 bg-white text-center h-screen">
            <div className="container mx-auto max-w-3xl">
                <h2 className="text-2xl font-bold mb-5 text-slate-900">Sell Your Items</h2>
                ...
                <p className="leading-relaxed text-lg mb-5 text-slate-900">
                ...
                <a href="#sell" className="inline-block px-5 py-2 text-lg text-white bg-slate-900 rounded hover:opacity-80">
                    Start Selling
                </a>
            </div>
        </div>
